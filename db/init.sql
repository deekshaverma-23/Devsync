...
('bob@example.com',   now() - interval '1 days',  NULL),               
('carol@example.com', now() - interval '3 days',  NULL),      
('dave@example.com',  NULL,                        now() - interval '5 days'),
('erin@example.com',  now() - interval '6 hours',  NULL);       
...
(1, 'SUCCESS', NULL,                          now() - interval '3 hours'), 
(2, 'SUCCESS', now() - interval '2 hours',    now() - interval '2 hours'), 
(3, 'SUCCESS', now() - interval '1 day',      now() - interval '1 day'), 
